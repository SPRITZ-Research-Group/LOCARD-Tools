...
public class YogaNode implements Cloneable {
    ...
    public void setMeasureFunction(c cVar) {
        ...
        jni_YGNodeSetHasMeasureFunc(this.mNativePointer, cVar != null);
    }

    @DoNotStrip
    public final long measure(float f, int i, float f2, int i2) {
        if (isMeasureDefined()) {
            return this.mMeasureFunction.a(this, f, YogaMeasureMode.fromInt(i), f2, YogaMeasureMode.fromInt(i2));
        }
    ...
    public void setBaselineFunction(a aVar) {
        ...
        jni_YGNodeSetHasBaselineFunc(this.mNativePointer, aVar != null);
    }

    @DoNotStrip
    public final float baseline(float f, float f2) {
        return this.mBaselineFunction.a();
    }
