...
public final class acqo {
    public static final <T> Class<T> a(acua<T> acua) {
        Class<T> a = ((acrr) acua).a();
        if (a != null) {
            return a;
        }
    ...
    public static final <T> Class<T> b(acua<T> acua) {
        Class<T> a = ((acrr) acua).a();
        if (!a.isPrimitive()) {
    ...
    public static final <T> Class<T> c(acua<T> acua) {
        Class<T> a = ((acrr) acua).a();
        if (a.isPrimitive()) {
            String name = a.getName();
            if (name != null) {
    ...
    public static final <T extends Annotation> acua<? extends T> a(T t) {
        acua<? extends T> a = acso.a(t.annotationType());
        if (a != null) {
            return a;
        }
        throw new v("null cannot be cast to non-null type kotlin.reflect.KClass<out T>");
    }
}
