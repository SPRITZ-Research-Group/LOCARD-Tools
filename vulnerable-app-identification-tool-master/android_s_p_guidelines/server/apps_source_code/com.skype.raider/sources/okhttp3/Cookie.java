...
public final class Cookie {
    ...
    public final boolean matches(HttpUrl url) {
        boolean equals;
        if (this.hostOnly) {
            equals = url.host().equals(this.domain);
        } else {
            equals = domainMatch(url.host(), this.domain);
        }
        if (!equals || !pathMatch(url, this.path)) {
            return false;
        }
    ...
    final String toString(boolean forObsoleteRfc2965) {
