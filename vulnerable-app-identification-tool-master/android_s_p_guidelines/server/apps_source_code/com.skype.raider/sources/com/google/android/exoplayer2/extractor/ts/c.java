...
public final class c implements f {
    ...
    public final boolean a(g input) throws IOException, InterruptedException {
        ...
        while (true) {
            input.c(scratch.a, 0, 2);
            scratch.c(0);
            if ((scratch.h() & 65526) != 65520) {
                validFramesCount = 0;
                validFramesSize = 0;
                input.a();
                headerPosition++;
                ...
                scratchBits.a(14);
                int frameSize = scratchBits.c(13);
                if (frameSize <= 6) {
                    return false;
                }
                input.c(frameSize - 6);
    ...
    public final void a(h output) {
        ...
        output.b();
        output.a(new a(-9223372036854775807L));
    }
    ...
    public final int a(g input, l seekPosition) throws IOException, InterruptedException {
        int bytesRead = input.a(this.d.a, 0, 200);
        if (bytesRead == -1) {
            return -1;
        }
        this.d.c(0);
