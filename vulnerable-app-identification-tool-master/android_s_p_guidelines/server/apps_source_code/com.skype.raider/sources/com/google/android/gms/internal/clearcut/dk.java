...
interface dk {
    ...
    @Deprecated
    void b(int i, Object obj, bz bzVar) throws IOException;

    void b(int i, List<h> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, bz bzVar) throws IOException;
