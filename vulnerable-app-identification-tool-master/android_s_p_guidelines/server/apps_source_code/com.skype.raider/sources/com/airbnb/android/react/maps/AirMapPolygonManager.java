...
public class AirMapPolygonManager extends ViewGroupManager<AirMapPolygon> {
    ...
    public AirMapPolygonManager(ag reactContext) {
    ...
    public AirMapPolygon createViewInstance(ae context) {
        return new AirMapPolygon(context);
    }

    @ReactProp(name = "coordinates")
    public void setCoordinate(AirMapPolygon view, al coordinates) {
