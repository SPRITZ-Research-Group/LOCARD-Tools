...
public enum PROPKEY {
    ...
    ACCOUNT_OFFLINE_CALLFORWARD(StatusLine.HTTP_PERM_REDIRECT),
    ...
    FIRST_EXTENDED_PROPKEY(Constants.ONE_SECOND),
    ...
    private static final m<PROPKEY> intToTypeMap = null;
    private final int value;

    static {
        intToTypeMap = new m();
        PROPKEY[] values = values();
        int length = values.length;
        int i;
        while (i < length) {
            PROPKEY type = values[i];
            intToTypeMap.a(type.value, type);
            i++;
        }
    }

    private PROPKEY(int value) {
        this.value = value;
    }
    ...
    public static PROPKEY fromInt(int i) {
        PROPKEY tmpVar = (PROPKEY) intToTypeMap.a(i);
