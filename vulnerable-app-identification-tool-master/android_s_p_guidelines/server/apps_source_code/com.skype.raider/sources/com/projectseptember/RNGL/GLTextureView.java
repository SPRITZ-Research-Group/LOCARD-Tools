...
public class GLTextureView extends TextureView implements Callback, SurfaceTextureListener {
        ...
        switch (msg.what) {
            ...
            case 2:
                if (Log.isLoggable(this.a, 3)) {
                    new StringBuilder("handleMessage: MSG_TEXTURE_AVAILABLE enter surfaceTexture ").append(System.identityHashCode(msg.obj)).append(" width ").append(msg.arg1).append(" height ").append(msg.arg2).append(a());
                }
            ...
            case 4:
                if (Log.isLoggable(this.a, 3)) {
                    new StringBuilder("handleMessage: MSG_TEXTURE_DESTROYED enter surfaceTexture ").append(System.identityHashCode(msg.obj)).append(a());
                }
                this.i.release();
                this.i = null;
                if (this.j != null) {
            ...
            case 5:
                if (Log.isLoggable(this.a, 3)) {
                    new StringBuilder("handleMessage: MSG_SET_RENDERER enter renderer ").append(System.identityHashCode(msg.obj)).append(a());
                }
                n renderer = msg.obj;
                if (renderer != null) {
                    this.f = true;
                ...
                if (Log.isLoggable(this.a, 3)) {
                    new StringBuilder("handleMessage: MSG_SET_RENDERER exit renderer ").append(System.identityHashCode(msg.obj)).append(a());
                    break;
                }
                break;
            case 6:
    ...
    public void setRenderer(n renderer) {
        if (Log.isLoggable(this.a, 3)) {
