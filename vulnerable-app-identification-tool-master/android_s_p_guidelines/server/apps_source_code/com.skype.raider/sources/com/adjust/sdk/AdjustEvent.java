...
public class AdjustEvent {
    ...
    public void addCallbackParameter(String key, String value) {
        if (Util.isValidParameter(key, PropertiesEntry.COLUMN_NAME_KEY, "Callback") && Util.isValidParameter(value, PropertiesEntry.COLUMN_NAME_VALUE, "Callback")) {
    ...
    public void addPartnerParameter(String key, String value) {
        if (Util.isValidParameter(key, PropertiesEntry.COLUMN_NAME_KEY, "Partner") && Util.isValidParameter(value, PropertiesEntry.COLUMN_NAME_VALUE, "Partner")) {
