...
import os, sys, subprocess, glob, argparse, time, re
import logging
from datetime import datetime

sys.stdout = open("ofile.txt", "w+")
...
if __name__ == '__main__':
	...
	logging.info('- Time this was run.')
	...
	with open("ofile.txt", "r") as read_obj:
...
uni_dict = {
	"info": {
		"_postman_id": "763097bc-c945-4f0d-819d-6ea6aa10969a",
		"name": "unipd",
		"schema": "https://schema.getpostman.com/json/collection/v2.1.0/collection.json"
	},
	"item": [
		{
			"name": "https://bpm6.locard.motivian.com/locard/rest/externalAgent/submitEvidence",
			...
			"request": {
				...
				"url": {
					"raw": "https://bpm6.locard.motivian.com/locard/rest/externalAgent/submitEvidence",
					"protocol": "https",
					"host": [
						"bpm6",
						"locard",
			...
			"response": "Check the output.txt file for any vulnerabilities"
		}
	]
}

with open('unipd.json', 'w') as json_file:
    json.dump(uni_dict, json_file, indent = 4, sort_keys=True)
